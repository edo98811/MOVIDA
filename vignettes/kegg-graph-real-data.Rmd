...
# Enrichment analysis ----------------------------------------------------------
de_entrez_IFNg_vs_naive_genes <- anns_entrez$ENTREZID[
...
# save-------------------------------------------------
save(dds, res_enrich_IFNg_vs_naive_dds, res_macrophage_IFNg_vs_naive_dds, res_macrophage_IFNg_vs_naive_limma, fit2, anns, file = system.file("extdata", "quick_startup.RData", package="MOVIDA"))
...
de_results_list <-list(
  trans_limma = list(
    de_table = res_macrophage_IFNg_vs_naive_limma,
