#  writing tests with copilot: https://docs.github.com/en/copilot/tutorials/write-tests
...
model <- MOVIDA::MovidaModel$new(movida_list)
model_se <- MOVIDA::MovidaModel$new(movida_list_se)
